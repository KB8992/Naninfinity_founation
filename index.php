      ...
      <div class="wrapper">
        ...
        <ul class="nav-links">
          ...
          <li>
            ...
            <ul class="drop-menu1">
              <li><a href="aboutus.php#Mission" onclick="scrollToSection('Mission')">Our Mission</a></li>
              <li><a href="aboutus.php#Chairperson's Message" onclick="scrollToSection('Chairperson\'s Message')">Chairperson's Message</a></li>
              <li><a href="aboutus.php#endpoints" onclick="scrollToSection('endpoints')">President's Message</a></li>
              <li><a href="aboutus.php#objectives" onclick="scrollToSection('objectives')">Objectives</a></li>
              </ul>
              </li>
              <li>
              ...
              <ul class="drop-menu2">
              <li><a href="education.php#education-section" onclick="scrollToSection('education-section')">Education</a></li>
              <li><a href="health.php#health-section" onclick="scrollToSection('health-section')">Health</a></li>
              <li><a href="Food.php#food-section" onclick="scrollToSection('food-section')">Food</a></li>
              </ul>
              </li>
    ...
    <div id="demo" class="carousel slide" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <a href="donate.php"><img src="images/Website - 1.png" alt="" class="d-block w-100"></a>
        </div>
        <div class="carousel-item">
          <a href="donate.php"><img src="images/Website - 2.png" alt="" class="d-block w-100"></a>
        </div>
        <div class="carousel-item">
          <a href="donate.php"><img src="images/Website - 3.png" alt="" class="d-block w-100"></a>
        </div>
        <div class="carousel-item">
          <a href="donate.php"><img src="images/Website - 4.png" alt="" class="d-block w-100"></a>
        </div>
        <div class="carousel-item">
          <a href="donate.php"><img src="images/Website - 5.png" alt="" class="d-block w-100"></a>
        </div>
        <div class="carousel-item">
          <a href="donate.php"><img src="images/Website - 6.png" alt="" class="d-block w-100"></a>
        </div>     
      </div>
...
<!-- vision -->
  <section>
    <div class="container-fluid vision">
      ...
      <p>To make a substantial positive difference in the socioeconomic position of rural community by providing excellent Health, Education and Environment (HEE) to worthy individuals.</p>
      </div>
    </div>
  </section>
<!-- vision end -->
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-lg-8 col-md-8 col-12 aboutfounder">
            ...
            <br>
            <p><b><i>Dr.N.Pitchumani</i></b>, Founder, NanInfinity Foundation.</p>
  ...
  <div class="videobox">
    <center>
      ...
      <div class="video-player">
        <video
          src="images/final1.mp4"
          poster="images/videobg.jpeg"
          class="video">
        </video>
  ...
  <div class="logoscroll">
    <div class="marquee">
        <ul class="marquee-content">
          <li><a href="index.php"><img src="images/logonewtrans.jpg"></a></li>
          <li><a href="https://www.linkedin.com/company/nan-infinity-care-a-unit-of-nan-infinity-foundation/" target="_blank"><img src="images/Logo-03.png"></a></li>
          <li><a href="https://www.linkedin.com/company/better-together-a-unit-of-nan-infinity-foundation/" target="_blank"><img src="images/Logo-01.png"></a></li>
          <li><a href="https://www.linkedin.com/company/change-makers-a-unit-of-nan-infinity-foundation/" target="_blank"><img src="images/Logo-02.png"></a></li>
        </ul>
    </div>
  </div>
  <script src="./scripts/logoscroll.js"></script>
          ...
          <div class="center box">
            ...
            <div class="content">
              <div class="place">
                ...
                <span class="text">Kolathur,Chennai,Tamilnadu,India</span>
              </div>
              <div class="phone">
                <a href="tel:+91 6369308462"><span class="fas fa-phone-alt"></span></a>
                <a href="tel:+91 6369308462"><span class="text">+91 6369308462</span></a>
              </div>
              <div class="email">
              ...
              <div class="social">
                <a href="https://www.facebook.com/naninfinityfoundation/" target="_blank"><span class="fab fa-facebook-f"></span>
                </a>
          ...
          <div class="right box">
            ...
            <div class="content">
              <form class="contact" action="" method="post">
                ...
                <div class="policies">
                  <li><a href = "terms.php"><span class="text">Terms of Use</span></a></li>
                  <li><a href = "contactus.php"><span class="text">Contact US</span></a></li>
                  <li><a href = "privacy.php"><span class="text">Privacy Policy</span></a></li>
                </div>
                </form>
            </div>
          </div>
